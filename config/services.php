...
return [
    ...
    */
    ...
    'heygen' => [
        ...
        'public_avatar_details_timeout' => (int) env('HEYGEN_PUBLIC_AVATAR_DETAILS_TIMEOUT', 25),
        'public_avatar_details_retry_times' => (int) env('HEYGEN_PUBLIC_AVATAR_DETAILS_RETRY_TIMES', 0),
